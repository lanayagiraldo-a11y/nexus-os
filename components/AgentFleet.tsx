    ...
    <div className="flex flex-col gap-6 p-6 overflow-y-auto h-full">
      ...
      <motion.div initial={{opacity:0}} animate={{opacity:1}} transition={{delay:0.45}} className="rounded-xl p-4" style={{background:"rgba(109,40,217,0.03)",border:"1px solid rgba(109,40,217,0.08)"}}>
        ...
        <div className="grid grid-cols-2 gap-x-8 gap-y-1">
          {[{key:"CLAUDE_API_KEY",val:"sk-ant-...",color:"#F72585"},{key:"OPENAI_API_KEY",val:"sk-proj-...",color:"#00A676"},{key:"GEMINI_API_KEY",val:"AIza...",color:"#5F8C94"},{key:"HERMES_BASE_URL",val:"http://localhost:11434",color:"#6D28D9"}].map(({key,val,color})=>(
